<div class="flex-1 p-8 bg-white min-h-screen font-sans">
    ...
    <div class="max-w-7xl mx-auto space-y-10">
        ...
        <div
            class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 pb-8 border-b border-gray-100">
            {{-- Judul & Subjudul --}}
            <div>
                <h1 class="text-3xl font-bold text-[#0f5132] tracking-tight mb-1">Daftar Kegiatan</h1>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-8">
                    <div>
                        <span class="block text-2xl font-bold text-gray-900">{{ $activities->count() }}</span>
                    ...
                    <div>
                        ...
                        <span class="text-xs font-medium text-gray-400 uppercase tracking-wider">Partner</span>
                    </div>
                    <div class="w-px h-8 bg-gray-100"></div> {{-- Divider --}}
                    <div>
                        <span
                            class="block text-2xl font-bold text-gray-900">{{ $activities->sum(fn($a) => $a->photos ? $a->photos->count() : 0) }}</span>
                        <span class="text-xs font-medium text-gray-400 uppercase tracking-wider">Foto</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            @forelse ($activities as $activity)
                ...
                <div class="group flex flex-col h-full">
                    ...
                    <div class="relative aspect-[3/2] overflow-hidden rounded-xl bg-gray-100 mb-4">
                        ...
                        <div
                            class="absolute top-3 left-3 px-2 py-1 bg-white/95 backdrop-blur rounded text-[10px] font-bold uppercase tracking-wider text-gray-800">
                    ...
                    <div class="flex flex-col flex-grow">
                        ...
                        <div class="flex items-center gap-2 mb-2 text-xs text-gray-500">
                            <span
                                class="font-semibold text-[#0f5132]">{{ Str::limit($activity->partner->name, 20) }}</span>
                        ...
                        {{-- Title --}}
                        <h3
                            class="text-lg font-bold text-gray-900 leading-snug mb-2 group-hover:text-[#0f5132] transition-colors">
                            <a href="{{ route('admin.activity.show', $activity->slug) }}">
                                {{ $activity->title }}
                            </a>
                        </h3>
                        ...
                        <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                            <a href="{{ route('admin.activity.show', $activity->slug) }}"
                                class="text-xs font-bold text-gray-900 border-b border-transparent hover:border-gray-900 transition-all pb-0.5">
                                LIHAT DETAIL
                            </a>
        ...
        {{-- Loading --}}
        <div wire:loading
            class="fixed bottom-8 left-1/2 -translate-x-1/2 bg-black text-white px-4 py-2 rounded-full text-xs font-bold shadow-lg z-50">
            Loading...
        </div>
    ...
    @if ($confirmingActivityDeletion)
        <div
            class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/80 backdrop-blur-sm animate-fadeIn">
            <div
