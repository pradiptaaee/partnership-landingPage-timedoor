...
<div id="deleteModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
    <div class="bg-white w-full max-w-sm p-8 text-center animate-fadeIn shadow-2xl">
        <h3 class="text-lg font-bold text-gray-900 mb-2">Hapus Testimoni?</h3>
        <p class="text-sm text-gray-500 mb-8">Tindakan ini permanen. Lanjutkan?</p>
