        ...
        <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row h-full">
            ...
            <div class="w-full lg:w-5/12 p-8 border-b lg:border-b-0 lg:border-r border-gray-100 flex flex-col h-full bg-white">
                ...
                <div class="space-y-6 flex-grow overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="title[en]" 
                               value="{{ old('title.en') }}"
                               class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-gray-800 placeholder-gray-400 focus:bg-white focus:border-[#0f5132] focus:ring-1 focus:ring-[#0f5132] outline-none transition text-sm font-medium @error('title.en') border-red-500 bg-red-50 @enderror" 
                    ...
                    <div>
                        ...
                        <textarea name="description[en]" 
                                  rows="5"
                                  class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 text-gray-800 placeholder-gray-400 focus:bg-white focus:border-[#0f5132] focus:ring-1 focus:ring-[#0f5132] outline-none transition text-sm leading-relaxed @error('description.en') border-red-500 bg-red-50 @enderror"
                                  placeholder="Tuliskan deskripsi singkat banner di sini..." 
                    ...
                    <div class="p-4 bg-emerald-50 rounded-xl border border-emerald-100 flex gap-3 items-start">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-emerald-700 leading-relaxed">
                                Cukup isi Bahasa Indonesia/Inggris. Sistem otomatis menerjemahkan ke bahasa lain saat disimpan.
                            </p>
                        </div>
                    </div>
                ...
                <div class="pt-6 mt-6 border-t border-gray-100 flex gap-3 shrink-0">
                    <a href="{{ route('admin.banners.index') }}" class="flex-1 px-4 py-3 rounded-lg border border-gray-200 text-gray-600 text-sm font-bold text-center hover:bg-gray-50 hover:text-gray-800 transition">
                        Batal
                    </a>
            ...
            {{-- KOLOM KANAN: Upload Area (Modern Canvas Style) --}}
