                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select class="w-full appearance-none px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white cursor-pointer @error('partner_id') border-red-500 ring-2 ring-red-200 @enderror" 
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 @error('short_description') border-red-500 ring-2 ring-red-200 @enderror" 
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 @error('full_description') border-red-500 ring-2 ring-red-200 @enderror" 
                                      id="full_description" 
                                      name="full_description" 
                                      rows="6"
                                      placeholder="Jelaskan detail kegiatan, tujuan, hasil, dan hal-hal penting lainnya..." 
                                      required>{{ old('full_description', $activity->full_description) }}</textarea>
                    ...
                    <div class="p-6">
                        <ul class="space-y-4 text-sm">
                            <li>
                                ...
                                <code class="px-2 py-1 bg-gray-100 rounded text-xs text-gray-800 break-all">{{ $activity->slug }}</code>
                            </li>
                            <li>
