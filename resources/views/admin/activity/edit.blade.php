    ...
    <form action="{{ route('admin.activity.update', $activity->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Kosongkan jika tidak ingin mengganti. Rekomendasi: 1200x600px, maksimal 2MB</small>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i class="fas fa-images me-2"></i>Galeri Foto ({{ $activity->photos->count() }})</h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
...
function deletePhoto(photoId) {
    if (confirm('Hapus foto ini?')) {
        // You need to create a separate route and method for this
