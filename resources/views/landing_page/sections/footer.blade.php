{{-- SECTION: TRY FREE CLASS --}}
<section class="w-full bg-[#2a355b] py-10 border-b border-white/5">
    ...
    <div class="max-w-screen-xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-wrap justify-center gap-y-12 gap-x-8 lg:gap-x-12 mb-12">
            ...
            <div class="w-full sm:w-[45%] lg:w-[17%] text-white">
                ...
                <div class="flex items-center gap-2 mb-4 text-xs text-gray-300 hover:text-white transition">
            ...
            <div class="w-full sm:w-[45%] lg:w-[17%] text-white">
                ...
                <div class="flex items-center gap-2 mb-4 text-xs text-gray-300 hover:text-white transition">
                    <span>✉</span> <span>info@timedooracademy.com</span>
                </div>
            </div>
            ...
            <div class="w-full sm:w-[45%] lg:w-[17%] text-white">
                ...
                <div class="flex items-center gap-2 mb-4 text-xs text-gray-300 hover:text-white transition">
                    <span>✉</span> <span>sy@timedooracademy.com</span>
                </div>
            </div>
            ...
            <div class="w-full sm:w-[45%] lg:w-[17%] text-white">
                ...
                <div class="flex items-center gap-2 mb-4 text-xs text-gray-300 hover:text-white transition">
                    <span>✉</span> <span>bg@timedooracademy.com</span>
                </div>
            </div>
...
{{-- FOOTER --}}
<footer class="w-full bg-[#182140] pt-12 pb-8 border-t border-gray-700/50">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
                <div class="w-32 mb-6">
                    <svg width="166" height="43" viewBox="0 0 166 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M126.495 32.7019H116.618C116.702 33.6786 117.042 34.442 117.642 34.9955C118.243 35.549 118.984 35.8239 119.86 35.8239C121.126 35.8239 122.03 35.2776 122.566 34.1887H126.249C125.858 35.4911 125.109 36.5583 124.006 37.3939C122.899 38.2332 121.542 38.6492 119.932 38.6492C118.63 38.6492 117.465 38.3598 116.434 37.7847C115.403 37.2094 114.596 36.3919 114.021 35.3319C113.446 34.2755 113.156 33.0564 113.156 31.6745C113.156 30.2781 113.439 29.0517 114.01 27.9917C114.578 26.9354 115.374 26.1214 116.398 25.5535C117.422 24.9855 118.601 24.6997 119.932 24.6997C121.216 24.6997 122.367 24.9746 123.383 25.5281C124.4 26.0816 125.189 26.8667 125.749 27.8796C126.31 28.8961 126.592 30.061 126.592 31.3778C126.592 31.8734 126.56 32.3112 126.495 32.7019ZM123.054 30.4119C123.04 29.5328 122.721 28.831 122.103 28.3029C121.484 27.7747 120.728 27.5106 119.835 27.5106C118.988 27.5106 118.279 27.7674 117.7 28.2775C117.125 28.7912 116.77 29.5003 116.64 30.4119H123.054Z" fill="white" />
        ...
        <div class="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 gap-4">
            ...
            {{-- LANGUAGE SWITCHER --}}
            <div class="flex gap-6 font-medium flex-wrap justify-center">
                {{-- Indonesia --}}
                <a href="{{ route('switch.language', 'id') }}" 
                   class="transition {{ app()->getLocale() == 'id' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   Indonesia
                </a>

                {{-- English --}}
                <a href="{{ route('switch.language', 'en') }}" 
                   class="transition {{ app()->getLocale() == 'en' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   English
                </a>

                {{-- Malaysia --}}
                <a href="{{ route('switch.language', 'ms') }}" 
                   class="transition {{ app()->getLocale() == 'ms' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   Malaysia
                </a>

                {{-- Philippines --}}
                <a href="{{ route('switch.language', 'fil') }}" 
                   class="transition {{ app()->getLocale() == 'fil' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   Philippines
                </a>

                {{-- Egypt/Syria (Arab) --}}
                <a href="{{ route('switch.language', 'ar') }}" 
                   class="transition {{ app()->getLocale() == 'ar' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   عربي
                </a>

                {{-- Japan --}}
                <a href="{{ route('switch.language', 'ja') }}" 
                   class="transition {{ app()->getLocale() == 'ja' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   日本語
                </a>

                {{-- Bangladesh --}}
                <a href="{{ route('switch.language', 'bn') }}" 
                   class="transition {{ app()->getLocale() == 'bn' ? 'text-white font-bold underline' : 'hover:text-white' }}">
                   বাংলা
                </a>
            </div>
