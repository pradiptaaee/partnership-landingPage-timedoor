<section class="w-full bg-[#10AF13]">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <!-- Swiper Testimonial V2 -->
        <!-- <div class="swiper swiperRight bg-white rounded-[2.5rem] shadow-xl mb-12">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="p-8 sm:p-12">
                            <div class="flex gap-0">
                                <div class="w-2/5">
                                    <div class="w-[100px] h-[100px] md:w-[200px] md:h-[200px] lg:w-[300px] lg:h-[300px] bg-gray-200 overflow-hidden">
                                        <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1888&auto=format&fit=crop" class="w-full h-full object-cover">
                                    </div>
                                    <div class="text-blue-900">
                                        <p class="font-extrabold text-xs md:text-xl lg:text-3xl">Parents Name</p>
