    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mt-5 sm:mt-12 max-w-5xl mx-auto">
            ...
            <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="500" class="flex md:flex-row gap-4 items-stretch">
                <a class="flex items-center justify-center w-4/5 p-2 bg-[#10AF13] hover:bg-green-700 text-white font-black {{ $fontClasses['cta_btn'] ?? 'text-base sm:text-3xl md:text-4xl' }} rounded-2xl shadow-lg transition transform hover:-translate-y-1 uppercase tracking-wide">
                    {{ __('Button Price') }}
                </a>
