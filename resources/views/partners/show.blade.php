...
@section('content')
    ...
    <section class="hero-detail position-relative mb-5" style="height: 500px; overflow: hidden;">
        @if ($activity->featured_image_url)
            <img src="{{ $activity->featured_image_url }}" class="card-img-top" alt="{{ $activity->title }}"
    ...
    <div class="container mb-5">
        ...
        <!-- Main Content Grid -->
        @if ($activity->hasExtraDescription())
        <div class="row g-4 mb-5">

            <!-- Visual Highlight -->
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 15px; overflow: hidden;">
                    <img src="{{ $activity->photos_image }}" alt="{{ $activity->title }}" class="w-100"
                ...
                @forelse ($activity->photos as $index => $photo)
                    <div class="{{ $index === 0 ? 'col-md-8' : 'col-md-4' }}">
                        <div class="gallery-box {{ $index === 0 ? 'gallery-large' : 'gallery-small' }}">
                            <img src="{{ asset('storage/' . $photo->path) }}" alt="Galeri {{ $activity->title }}"
        ...
        <div class="text-center">
            ...
            <div class="d-flex gap-3 justify-content-center">
                ...
                <a href="#" class="btn rounded-circle"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 1200 1227"
                        fill="#ffffff">
                        <path
                            d="M714.163 519.284L1160.89 0H1050.45L667.137 442.632L356.724 0H0L468.288 681.329L0 1226.98H110.451L513.219 751.911L843.275 1226.98H1200L714.163 519.284ZM563.556 687.92L517.62 620.38L156.432 94.5713H301.306L600.036 521.657L645.972 589.196L1023.67 1132.41H878.792L563.556 687.92Z" />
                    </svg>
                ...
                <a href="#" class="btn rounded-circle"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
                        <path fill="#FFF"
                            d="M20 4H4C2.9 4 2 4.9 2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2Zm-.4 3.25-7.2 4.5-7.2-4.5V6.5l7.2 4.5 7.2-4.5v.75Z" />
                    </svg>
                </a>
            </div>
        </div>
