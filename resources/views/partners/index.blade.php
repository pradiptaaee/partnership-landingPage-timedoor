...
<section class="workshop-section py-5">
    <div class="container">
        ...
        <div class="container my-5">
            <div class="search-wrapper mx-auto py-3 px-4 shadow-sm"
                ...
                <form action="{{ route('partners.index') }}" method="GET" class="d-flex gap-3">
                    ...
                    <!-- FILTER DROPDOWN -->
                    <div class="dropdown">
                        <button class="btn btnFilter px-4 dropdown-toggle"
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        <p class="date-text">25 Februari 2024</p>
                        <h5 class="card-title-color">Workshop Inovasi Pembelajaran</h5>
                        <p class="text-muted flex-grow-1">Meningkatkan kreativitas guru dalam merancang pembelajaran inovatif.</p>
                        <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                            class="btn btn-primary mt-3">
                            <i class="bi bi-eye me-2"></i>Lihat Detail
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        <p class="date-text">28 Februari 2024</p>
                        <h5 class="card-title-color">Pelatihan Leadership Guru</h5>
                        <p class="text-muted flex-grow-1">Pengembangan karakter kepemimpinan guru dalam kegiatan sekolah.</p>
                        <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                            class="btn btn-primary mt-3">
                            <i class="bi bi-eye me-2"></i>Lihat Detail
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        <p class="date-text">3 Maret 2024</p>
                        <h5 class="card-title-color">Pelatihan Manajemen Sekolah</h5>
                        <p class="text-muted flex-grow-1">Peningkatan kemampuan manajemen administratif dan operasional sekolah.</p>
                        <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                            class="btn btn-primary mt-3">
                            <i class="bi bi-eye me-2"></i>Lihat Detail
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <p class="text-muted flex-grow-1">Pembekalan keterampilan digital untuk menunjang pembelajaran modern.</p>
                        <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                            class="btn btn-primary mt-3">
                            <i class="bi bi-eye me-2"></i>Lihat Detail
                        </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="text-muted flex-grow-1">Peningkatan komunikasi, empati, dan manajemen emosi guru.</p>
                            <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                                class="btn btn-primary mt-3">
                                <i class="bi bi-eye me-2"></i>Lihat Detail
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="text-muted flex-grow-1">Membuat media pembelajaran yang menarik dan interaktif.</p>
                            <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                                class="btn btn-primary mt-3">
                                <i class="bi bi-eye me-2"></i>Lihat Detail
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="text-muted flex-grow-1">Teknik evaluasi pembelajaran yang efektif dan efisien.</p>
                            <a href="{{ route('partners.show', 'workshop-digital-learning') }}"
                                class="btn btn-primary mt-3">
                                <i class="bi bi-eye me-2"></i>Lihat Detail
                            </a>
